const CACHE='chokin-v082';
const ASSETS=['./','./index.html','./favicon.svg','./icons/icon-192.png','./icons/icon-512.png','./icons/icon-maskable-512.png','./icons/apple-touch-icon.png','./styles.css','./fixes.css','./v021-quick.css','./v03-scenes.css','./v04-canvas.css','./v05-fever.css','./v05-controls.css','./v051-polish.css','./v06-cats.css','./v08-collection.css','./cat-collection.js','./cat-characters.js','./game-effects.js','./asset-loader.js','./canvas-effects.js','./app.js','./assets/manifest.json','./assets/cats/cat-catalog.json','./manifest.webmanifest'];
