...
const SHELL_ASSETS = [
  ...
  './assets/hero/hero-banner-cat-room-v1.webp',
  ...
  './v0911-restore-preview.css', './v0912-onboarding.css', './v0913-daily-note.css', './v0916-capsule-gacha.css', './v10-room-theme.css?v=6',
  ...
  './restore-preview.js?v=1.6', './app.js?v=1.0.11', './assets/manifest.json', './assets/cats/cat-catalog.json',
  './cat-life-financial-activation.js?v=1', './cat-life-startup.js?v=4', './cat-life-restore.js?v=3', './cat-life-coordination.js?v=3', './cat-life-financial.js?v=1', './cat-life-financial-transaction.js?v=4', './cat-life-financial-runtime.js?v=2',
  './cat-life-goal-progression.js?v=1', './cat-life-goal-progression-runtime.js?v=2',
  './cat-life-runtime.js?v=2', './cat-life.js?v=1', './cat-life-view.js?v=5', './cat-life-events.js?v=2', './backup-v2.js?v=5', './assets/cats/cat-world.json?v=1'
];
